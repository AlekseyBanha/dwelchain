...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/css/styles.css') }}?v=20260727-mapvisual">
...
<body data-page="map">
  ...
  <main>
    <section class="map-page-head section-shell">
      <nav class="breadcrumbs breadcrumbs--compact" aria-label="Навігаційний шлях"><a href="{{ url('/') }}">Головна</a><span>·</span><span>Карта</span></nav>
      <p class="eyebrow"><span></span> Пошук за розташуванням</p>
      <div class="map-page-head__row">
        <div>
          <h1>Об’єкти на карті Києва</h1>
          <p>Переглядайте приблизне розташування об’єктів за районом і параметрами пошуку.</p>
        </div>
