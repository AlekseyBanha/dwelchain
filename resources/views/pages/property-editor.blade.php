...
<body data-page="account" data-portal-page="property-editor">
  ...
  <main class="account-page">
    <div class="section-shell" id="property-editor-root" aria-live="polite">
      <div class="portal-loading portal-loading--page" role="status"><span></span><b>Готуємо редактор об’єкта…</b></div>
    </div>
  </main>
