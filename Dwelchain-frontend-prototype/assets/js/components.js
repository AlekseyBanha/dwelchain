...
export function headerMarkup(active) {
  return `<header class="site-header"><div class="section-shell site-header__inner">
    <a class="brand" href="index.html" aria-label="Перейти на головну сторінку Dwelchain"><img class="brand__logo" src="assets/images/dwelchain-logo-clean.png" alt=""></a>
    <nav class="site-nav" aria-label="Основна навігація">
      <a class="${active === 'home' ? 'is-active' : ''}" href="index.html">Головна</a>
      <a class="${active === 'catalog' || active === 'property' ? 'is-active' : ''}" href="catalog.html">Каталог</a>
      <a class="${active === 'map' ? 'is-active' : ''}" href="map.html">Карта</a>
      <a href="index.html#business-model">Інвесторам</a>
      <a class="${active === 'auth' || active === 'account' ? 'is-active' : ''}" href="auth.html">Кабінет</a>
    </nav>
...
export function footerMarkup() {
  ...
  return `<footer class="site-footer" id="site-footer"><div class="section-shell">
    <div class="site-footer__top"><div><a class="brand brand--footer" href="index.html" aria-label="Перейти на головну сторінку Dwelchain"><img class="brand__logo" src="assets/images/dwelchain-logo-clean.png" alt=""></a><p>Нерухомість для купівлі та оренди в Києві.</p></div>
    <div><strong>Навігація</strong><a href="catalog.html">Каталог</a><a href="map.html">Карта</a><a href="auth.html">Особистий кабінет</a><a href="index.html#about">Про сервіс</a><a href="index.html#business-model">Інвесторам</a><button class="button button--footer" type="button" data-modal-open="manager-modal">Зв’язатися з менеджером</button><button class="button button--footer" type="button" data-modal-open="owner-modal">Запропонувати об’єкт</button></div>
...
export function renderPropertyCard(property) {
  ...
  return `<article class="property-card">
    <a class="property-card__image" href="property.html?id=${property.id}" aria-label="Переглянути об’єкт: ${property.title}">
      ${image}
    ...
    <div class="property-card__body">
      ...
      <div class="property-card__footer"><span>${propertyTypes[property.type]}</span><a href="property.html?id=${property.id}">Переглянути об’єкт <span aria-hidden="true">→</span></a></div>
    </div>
  </article>`;
}
